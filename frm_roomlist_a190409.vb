Public Class frm_roomlist_a190409

    Private Sub frm_roomlist_a190409_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Dim mysql As String = "SELECT * FROM TBL_ROOMS_A190409"
