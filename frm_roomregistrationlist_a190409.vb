Public Class frm_roomregistrationlist_a190409
    Private Sub frm_roomregistrationlist_a190409_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Dim mysql As String = "SELECT * FROM TBL_ROOM_REGISTRATION_A190409"
