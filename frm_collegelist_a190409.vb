Public Class frm_collegelist_a190409
    Private Sub frm_collegelist_a190409_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Dim mysql As String = "SELECT * FROM TBL_COLLEGES_A190409"
