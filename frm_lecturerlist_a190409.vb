Public Class frm_lecturerlist_a190409
    Private Sub frm_lecturerlist_a190409_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Dim mysql As String = "SELECT * FROM TBL_LECTURERS_A190409"
