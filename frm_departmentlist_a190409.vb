Public Class frm_departmentlist_a190409
    Private Sub frm_departmentlist_a190409_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Dim mysql As String = "SELECT * FROM TBL_DEPARTMENT_A190409"
